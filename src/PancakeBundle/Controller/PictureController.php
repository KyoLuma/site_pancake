...
use PancakeBundle\Entity\Picture;
...
class PictureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pictures = $em->getRepository('PancakeBundle:Picture')->findAll();
    ...
    {
        $picture = new Picture();
        $form = $this->createForm('PancakeBundle\Form\PictureType', $picture);
    ...
    {
        $deleteForm = $this->createDeleteForm($picture);
        $editForm = $this->createForm('PancakeBundle\Form\PictureType', $picture);
